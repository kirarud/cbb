...
export const Navigation: React.FC<NavigationProps> = ({ viewMode, setViewMode, language, overrides, onLogout }) => {
  ...
  return (
    <div className="fixed bottom-0 md:bottom-8 left-1/2 -translate-x-1/2 z-[9999] w-full max-w-6xl px-2 md:px-0 mb-2 md:mb-0 safe-area-inset-bottom pointer-events-auto">
      <nav 
        ref={navRef}
