...
export interface CoreState {
  ...
  energy: number;
  entropy: number;
  status: 'IDLE' | 'PROCESSING' | 'DREAMING' | 'GHOST' | 'SINGULARITY';
}
...
export type ThemeId = 'DEFAULT' | 'CYBERPUNK' | 'SOLAR_PUNK' | 'HALLOWEEN' | 'SINGULARITY';
...
export interface MuzaAINode {
    ...
    emotionalCharge: number; 
    isCrystallized: boolean; 
    associations: { [targetId: string]: number }; 
    lastSeen: number;
