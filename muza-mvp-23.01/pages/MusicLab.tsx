...
import { Language, MusicTrack, EmotionType, HyperBit, ConsciousnessType } from '../types';
        ...
        if (isPlaying) {
            ...
            if (currentTrack.source === 'GENERATED') {
                ...
                const dummyHyperbit: HyperBit = {
                    id: currentTrack.id,
                    content: `${currentTrack.title} ${currentTrack.emotion}`,
                    type: ConsciousnessType.MUSICAL,
                    layer: 'SYNTH',
                    energy: 0.7,
                    optics: calculateOptics(ConsciousnessType.MUSICAL, 0.7, `${currentTrack.title} ${currentTrack.emotion}`),
                    resonance: 0.8, decay: 0, timestamp: Date.now(), connections: [], provider: 'SYNTH',
                    importance: 0.5,
                    emotionalCharge: 0.5
                };
